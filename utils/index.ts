...
const menuItems: MenuItem[] = [
  {
    ...
    options: [
      ...
      { name: "Commercial Properties for sale", path: "/all-property", filters: { purpose: "sale", classification: "commercial" } },
  ...
  },
  {
    ...
    options: [
      ...
      { name: "Commercial Properties for rent", path: "/all-property", filters: { purpose: "rent", classification: "commercial" } },
