...
const ListYourPropForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (response.success) {
            ...
            setErrorMessage('');
            //router.push('/'); // Uncomment this if you want to redirect after successful submission
        } else {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="sm:flex sm:items-center">
                        ...
                        <div className="mt-1 flex flex-col sm:flex-row sm:space-x-2 w-full">
                            <select
                                name="country"
                                value={formData.country}
                                onChange={handleChange}
                                required
                                className="p-2 block flex-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            >
