...
const FeaturesBox: React.FC<FeaturesBoxProps> = ({
  ...
  return (
    <div
      onClick={handleClick}
      className={`flex flex-col items-center justify-center gap-2 border-b-2 hover:text-orange-300 transition cursor-pointer ${selected ? 'border-b-orange-500 text-orange-500' : 'border-transparent text-neutral-500'}`}>
      <Icon size={26} />
