  ...
  return (
    ...
    className="relative py-12 bg-gray-50">
      ...
      <div className="relative max-w-4xl mx-auto px-4">
        {/* Vertical line */}
        <div className="absolute left-4 md:left-8 lg:left-1/2 transform lg:-translate-x-1/2 h-full w-1 bg-orange-500"></div>
        ...
        <div className="space-y-10">
          {steps.map((step, index) => (
            <div 
              ...
              <div className="absolute left-1 md:left-8 lg:left-1/2 transform -translate-x-1/2 w-12 h-12 flex items-center justify-center z-10">
              ...
              <motion.div
                ...
                <div className="w-full max-w-sm">
                  <div className={`rounded-lg shadow-lg p-4 transition-transform transform hover:scale-105 duration-300 ease-in-out ${index % 2 === 0 ? 'bg-gradient-to-br from-orange-400 to-orange-600 text-white ml-4' : 'bg-white text-gray-800 ml-4 md:mr-4'}`}>
