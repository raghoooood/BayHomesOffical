    ...
    <div className="p-5 mt-12 z-20">
       ...
       <Breadcrumb  items={breadcrumbItems}/>
         ...
         <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-20">
          <HeroContainer title={"Your Complete Guide to Buying"} description={"Navigate Dubai's real estate market with ease using our expert guides tailored to your needs."}/>
