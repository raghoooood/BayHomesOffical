...
const RentGuidContent: React.FC<LatestPropProps> = ({ initialProperties }) => {
  ...
  // Scroll effect based on the current index
  useEffect(() => {
  ...
  // Properties to display based on the page size
  ...
  // Count properties by classification
  ...
  return (
    <Container>
      <Heading title='Properties for Rent in Dubai' start />      
...
export default RentGuidContent;
