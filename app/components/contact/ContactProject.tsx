...
const ContactProject: React.FC = () => {
  return (
    <section className="relative w-full min-h-screen">
      ...
      {/* Content */}
      <div className="relative flex flex-col justify-center w-full h-full p-6 lg:p-8 rounded-xl bg-white bg-opacity-80 shadow-lg">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-8 lg:mb-16">
          ...
          <div className="flex flex-col items-center lg:items-start justify-center lg:pr-8 mb-4 lg:mb-0">
            <h1 className="text-3xl md:text-4xl lg:text-5xl text-gray-800 font-bold text-center lg:text-left">
              Speak with our Real Estate Specialists Today
            </h1>
            <p className="text-gray-600 mt-3 md:mt-4 lg:mt-5 text-center lg:text-left">
